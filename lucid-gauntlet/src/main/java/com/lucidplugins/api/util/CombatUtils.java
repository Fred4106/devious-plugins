...
import static com.lucidplugins.api.util.EquipmentUtils.getWepSlotItem;
import static com.lucidplugins.api.util.InventoryUtils.getFirstItem;
...
public class CombatUtils
{
    ...
    public static void quickKeris(Client client)
    {
        ...
        Item keris = getFirstItem("Keris partisan of the sun");
        boolean kerisEquipped = getWepSlotItem().getName().contains("of the sun");
