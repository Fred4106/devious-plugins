...
public class OverlayPrayerBox extends Overlay
{
    ...
    @Inject
    OverlayPrayerBox(final Client client, final FredGauntletPlugin plugin, final FredGauntletConfig config, final SpriteManager spriteManager)
    {
        super(plugin);
    ...
    public Dimension render(final Graphics2D graphics)
    {
        ...
        if (prayerHighlightMode == FredGauntletConfig.PrayerHighlightMode.NONE || prayerHighlightMode == FredGauntletConfig.PrayerHighlightMode.WIDGET)
        {
            return null;
        }
