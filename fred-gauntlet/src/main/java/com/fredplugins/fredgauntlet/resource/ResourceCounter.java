package com.fredplugins.fredgauntlet.resource;
...
class ResourceCounter extends Counter
{
    ...
    ResourceCounter(final FredGauntletPlugin plugin, final Resource resource, final BufferedImage bufferedImage, final int count)
    {
