...
public interface DukeHelperConfig extends Config
{
    ...
    @ConfigSection(name = "Dodging", description = "Dodging settings", position = 1, keyName = "dodgingSection")
    ...
    @ConfigSection(name = "Color Settings", description = "Color settings", position = 2, keyName = "colorSection")
